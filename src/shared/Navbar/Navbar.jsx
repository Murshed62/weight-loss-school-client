...
const Navbar = () => {
  ...
  <div className="navbar-start">
    ...
    <Link className="btn btn-ghost normal-case text-xl"><img className="w-[80px]" src={logo} alt="" /></Link>
  </div>
  ...
  <div className="navbar-end">
    <Link to="login" className="btn bg-orange-500 hover:bg-[#fd1d1d] transition font-bold text-white">Login</Link>
  </div>
</div>
    );
};
